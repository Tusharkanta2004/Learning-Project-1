        ...
        <div class="row d-flex justify-content-center align-items-center">
            ...
            <div class="col-lg-6">
                <form action="" method="post">
                    ...
                    <div class="mt-4 pt-2">
                        <input type="submit" value="Register" class="bg-info py-2 px-3 border-0" name="admin_login">
                        <p class="small fw-bold mt-2 pt-1 mb-0">Don't you hava an account? <a href="admin_registration.php" class="text-danger">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
